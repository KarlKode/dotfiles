...
#defaults write NSGlobalDomain AppleHighlightColor -string "0.537 0.812 0.941"
...
# Shut off the display after 8 minutes
sudo systemsetup -setdisplaysleep 8 > /dev/null

# Shut off the hard disk after 5 minutes (doesn't matter anyway)
sudo systemsetup -setharddisksleep 5 > /dev/null
...
#sudo ln -s ${HOME}/Pictures/desktop.jpg /System/Library/CoreServices/DefaultDesktop.jpg
