...
prompt_pure_check_virtualenv() {
  # reset virtualenv
  prompt_pure_virtualenv=

  [[ -n ${VIRTUAL_ENV+"x"} ]] && prompt_pure_virtualenv="$(basename $VIRTUAL_ENV) "
}
...
prompt_pure_preprompt_render() {
	...
	# construct preprompt, beginning with virtual env
  local preprompt="%F{green}${prompt_pure_virtualenv}%f"
  # path
	preprompt+="%F{blue}%~%f"
	# git info
